export const works: {
  ...
  },
  {
    ...
    points: `
    「①グラフィックとして見た場合でも強度のある」「②分業的でない、デザインと実装が相互に影響し合う」サイトを作りたいという考えから生まれました。サイトを囲むフレームにの生成ロジックについては如何なる画面比率でも破綻なく、美しく見えるよう、相当数の感覚的な調整を加えています。Webコーディングで陥りがちなシステマチックな印象でないインタラクションを目指しました。
    `,
  },
  {
    title: "MIDW",
